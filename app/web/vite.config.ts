...
function primeIconsModernFontPlugin() {
  return {
    ...
    transform(code: string, id: string) {
      ...
      return code.replace(
        /src:\s*url\('\.\/fonts\/primeicons\.eot'\);\s*src:\s*url\('\.\/fonts\/primeicons\.eot\?#iefix'\)\s*format\('embedded-opentype'\),\s*url\('\.\/fonts\/primeicons\.woff2'\)\s*format\('woff2'\),\s*url\('\.\/fonts\/primeicons\.woff'\)\s*format\('woff'\),\s*url\('\.\/fonts\/primeicons\.ttf'\)\s*format\('truetype'\),\s*url\('\.\/fonts\/primeicons\.svg\?#primeicons'\)\s*format\('svg'\);/,
