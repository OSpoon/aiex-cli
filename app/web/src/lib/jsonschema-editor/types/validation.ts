...
function getJsonStringType(t: Translation): z.ZodTypeAny {
  return z
    .object({
      minLength: z
        .number()
...
function getJsonNumberType(t: Translation): z.ZodTypeAny {
  return z
    .object({
      multipleOf: z
        .number()
      ...
      ({
        ...
        return enumValues.every((val) => {
          ...
          if (minimum !== undefined && val < minimum)
            return false
          if (maximum !== undefined && val > maximum)
            return false
...
function getJsonArrayType(t: Translation): z.ZodTypeAny {
  return z
    .object({
      minItems: z
        .number()
...
function getJsonObjectType(t: Translation): z.ZodTypeAny {
  return z
    .object({
      minProperties: z
        .number()
...
export function getTypeValidation(type: string, t: Translation): z.ZodTypeAny {
