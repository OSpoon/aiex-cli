    ...
    <form @submit="handleSubmit" class="space-y-6">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="space-y-4 min-w-[280px]">
          ...
          <div class="flex items-center gap-3 p-3 rounded-lg border border-border bg-secondary">
            <input
              type="checkbox"
              :id="fieldRequiredId"
        ...
        <div class="space-y-4 min-w-[280px]">
          ...
          <div class="rounded-lg border bg-muted/50 p-3 hidden md:block">
            ...
            <code class="text-sm bg-background/80 p-2 rounded block overflow-x-auto">
              <template v-if="fieldType === 'integer'">42</template>
              <template v-else-if="fieldType === 'number'">3.14</template>
              <template v-else-if="fieldType === 'string'">"example"</template>
