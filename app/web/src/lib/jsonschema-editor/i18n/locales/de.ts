...
export const de: Translation = {
  ...
  saveLabel: "Speichern",
  saveAndMigrateLabel: "Speichern & Migrieren",
  migrateSuccessToast: "Migration angewendet ({changes} Änderungen)",
  migrateNoChangesToast: "Keine Änderungen erkannt",
  migrateErrorToast: "Migration fehlgeschlagen",
  loadExampleLabel: "Beispiel laden"
}
