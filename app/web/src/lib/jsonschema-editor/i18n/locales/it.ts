...
export const it: Translation = {
  ...
  saveLabel: "Salva",
  saveAndMigrateLabel: "Salva e migra",
  migrateSuccessToast: "Migrazione applicata ({changes} modifiche)",
  migrateNoChangesToast: "Nessuna modifica rilevata",
  migrateErrorToast: "Migrazione fallita",
  loadExampleLabel: "Carica esempio"
}
