...
export const ru: Translation = {
  ...
  saveLabel: 'Сохранить',
  saveAndMigrateLabel: 'Сохранить и мигрировать',
  migrateSuccessToast: 'Миграция применена ({changes} изменений)',
  migrateNoChangesToast: 'Изменений не обнаружено',
  migrateErrorToast: 'Миграция не удалась',
  loadExampleLabel: 'Загрузить пример',
}
