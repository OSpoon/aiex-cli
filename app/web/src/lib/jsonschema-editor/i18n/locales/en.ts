...
export const en: Translation = {
  ...
  fieldTypeIntegerLabel: 'Integer',
  fieldTypeIntegerDescription: 'For whole numbers, primary keys, auto increment',
  fieldTypeNumberLabel: 'Real',
  fieldTypeNumberDescription: 'For decimal/floating point numbers',
  ...
  uniqueLabel: 'Unique',
  drizzleModeLabel: 'Drizzle Mode',
  drizzleModeNone: 'None',
  drizzleModeJson: 'JSON',
  drizzleModeTimestamp: 'Timestamp',
  drizzleModeTimestampMs: 'Timestamp (ms)',
  drizzleModeBoolean: 'Boolean',
  drizzleModeBigint: 'Bigint',
  customTypeLabel: 'Custom Type',
  customTypePlaceholder: 'e.g., text, blob',
  nestedEnabledLabel: 'Enable Nested',
  nestedRelationLabel: 'Relation Type',
  hasOneRelation: 'Has One',
  hasManyRelation: 'Has Many',
  defaultValueLabel: 'Default Value',
  defaultValuePlaceholder: 'Enter default value',
  saveLabel: 'Save',
  saveAndMigrateLabel: 'Save & Migrate',
  migrateSuccessToast: 'Migration applied ({changes} changes)',
  migrateNoChangesToast: 'No changes detected',
  migrateErrorToast: 'Migration failed',
