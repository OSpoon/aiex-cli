...
export const es: Translation = {
  ...
  saveLabel: "Guardar",
  saveAndMigrateLabel: "Guardar y migrar",
  migrateSuccessToast: "Migración aplicada ({changes} cambios)",
  migrateNoChangesToast: "Sin cambios detectados",
  migrateErrorToast: "Migración fallida",
  loadExampleLabel: "Cargar ejemplo"
}
