...
export const pl: Translation = {
  ...
  saveLabel: 'Zapisz',
  saveAndMigrateLabel: 'Zapisz i migruj',
  migrateSuccessToast: 'Migracja zastosowana ({changes} zmian)',
  migrateNoChangesToast: 'Nie wykryto zmian',
  migrateErrorToast: 'Migracja nie powiodła się',
  loadExampleLabel: 'Załaduj przykład',
}
