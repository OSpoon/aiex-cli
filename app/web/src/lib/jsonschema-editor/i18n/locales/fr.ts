...
export const fr: Translation = {
  ...
  // Missing fields - English fallback
  ...
  saveAndMigrateLabel: 'Sauvegarder et migrer',
  migrateSuccessToast: 'Migration appliquée ({changes} modifications)',
  migrateNoChangesToast: 'Aucun changement détecté',
  migrateErrorToast: 'Échec de la migration',
  loadExampleLabel: 'Charger un exemple',
}
