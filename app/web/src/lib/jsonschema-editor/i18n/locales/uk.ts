...
export const uk: Translation = {
  ...
  saveLabel: "Зберегти",
  saveAndMigrateLabel: "Зберегти та мігрувати",
  migrateSuccessToast: "Міграцію застосовано ({changes} змін)",
  migrateNoChangesToast: "Змін не виявлено",
  migrateErrorToast: "Міграція не вдалася",
  loadExampleLabel: "Завантажити приклад"
}
