export interface Translation {
   ...
   * > Number
   */
  readonly fieldTypeIntegerLabel: string
  /**
   * The translation for the key `fieldTypeIntegerDescription`. English default is:
   *
   * > For whole numbers, primary keys, auto increment
   */
  readonly fieldTypeIntegerDescription: string
  ...
  /**
   * The translation for the key `schemaTypeInteger`. English default is:
   *
   * > Integer
   */
  readonly schemaTypeInteger: string
  /**
  ...
  readonly schemaTitleLabel: string
  readonly schemaTitlePlaceholder: string
  readonly tableNamePlaceholder: string
  readonly timestampsLabel: string
  readonly softDeleteLabel: string
  readonly primaryKeyLabel: string
  readonly autoIncrementLabel: string
  readonly uniqueLabel: string
  readonly drizzleModeLabel: string
  readonly drizzleModeNone: string
  readonly drizzleModeJson: string
  readonly drizzleModeTimestamp: string
  readonly drizzleModeTimestampMs: string
  readonly drizzleModeBoolean: string
  readonly drizzleModeBigint: string
  readonly customTypeLabel: string
  readonly customTypePlaceholder: string
  readonly nestedEnabledLabel: string
  readonly nestedRelationLabel: string
  readonly hasOneRelation: string
  readonly hasManyRelation: string
  readonly defaultValueLabel: string
  readonly defaultValuePlaceholder: string
  readonly saveLabel: string
  readonly saveAndMigrateLabel: string
  readonly migrateSuccessToast: string
  readonly migrateNoChangesToast: string
  readonly migrateErrorToast: string
  readonly loadExampleLabel: string
}
